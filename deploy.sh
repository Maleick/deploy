...
apt update
apt install at bc bloodhound build-essential chromium dkms dnsmasq hostapd gss-ntlmssp powershell python3-pip mingw-w64 openjdk-11-jdk seclists wine32 -y
apt full-upgrade -y
apt autoremove
